<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form class="form-horizontal" action="<?php echo site_url() ?>admin/contraVoucher" method="post" enctype="multipart">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="voucher_number" name="voucher_number" class="form-control" value="<?php echo $contra_voucher_number + 1; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" name="save_contra" class="btn btn-success pull-right" id="save_contra" value="Complete Contra Voucher">Save Contra Voucher</button>
                        </div>                        
                    </div>                    
                </form>
            </div>

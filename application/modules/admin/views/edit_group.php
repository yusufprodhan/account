            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <form action="<?php echo site_url() ?>admin/updateGroup" method="post" accept-charset="utf-8">
                                    <?php
                                    $csrf = array(
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10 col-sm-12 col-xs-12">
                                                <input type="text" name="group_name"  id="group_name" class="form-control" value="<?php if(isset($get_editable_group)){if($get_editable_group ==!NULL){echo $get_editable_group[0]->group_name;}}?>" required="requried" placeholder="Enter group name">
                                                <input type="hidden" name="edit_id" value="<?php if(isset($get_editable_group)){if($get_editable_group ==!NULL){echo $get_editable_group[0]->id;}}?>">
                                                    ...
                                                    <?php if (isset($assets_group)): ?>
                                                        <?php if ($assets_group == !NULL): ?>
                                                            <?php foreach ($assets_group as $asset_group): ?>
                                                               <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->parent_id == $asset_group->id){echo 'selected';}}}?> value="<?php echo $asset_group->id ?>"><?php echo $asset_group->group_name ?></option>
                                                            <?php endforeach; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    </optgroup>
                                                    ...
                                                    <?php if (isset($expenses_group)): ?>
                                                        <?php if ($expenses_group == !NULL): ?>
                                                            <?php foreach ($expenses_group as $expense_group): ?>
                                                                <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->parent_id == $expense_group->id){echo 'selected';}}}?> value="<?php echo $expense_group->id ?>"><?php echo $expense_group->group_name ?></option>
                                                            <?php endforeach; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    </optgroup>
                                                    ...
                                                    <?php if (isset($incomes_group)): ?>
                                                        <?php if ($incomes_group == !NULL): ?>
                                                            <?php foreach ($incomes_group as $income_group): ?>
                                                                <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->parent_id == $income_group->id){echo 'selected';}}}?> value="<?php echo $income_group->id ?>"><?php echo $income_group->group_name ?></option>
                                                            <?php endforeach; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    </optgroup>
                                                    ...
                                                    <?php if (isset($liabilities_group)): ?>
                                                        <?php if ($liabilities_group == !NULL): ?>
                                                            <?php foreach ($liabilities_group as $liabilitie_group): ?>
                                                                <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->parent_id == $liabilitie_group->id){echo 'selected';}}}?> value="<?php echo $liabilitie_group->id ?>"><?php echo $liabilitie_group->group_name ?></option>
                                                            <?php endforeach; ?>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    </optgroup>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10 col-sm-12 col-xs-12">
                                                <select class="form-control select2" name="root_parent" id="root_parent" required="required">
                                                    <option></option>                                                    
                                                    <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->root_parent_id == 10){echo 'selected';}}}?> value="10">Assets</option>
                                                    <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->root_parent_id == 20){echo 'selected';}}}?> value="20">Expenses</option>
                                                    <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->root_parent_id == 30){echo 'selected';}}}?> value="30">Income</option>
                                                    <option <?php if(isset($get_editable_group)){if($get_editable_group == !NULL){if($get_editable_group[0]->root_parent_id == 40){echo 'selected';}}}?> value="40">Liabilities and Owners Equity</option>
                                                </select>
                                            </div>                                                                    
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="update_group" >Update</button>

                ...
                <form class="form-horizontal" action="<?php echo site_url() ?>admin/receiveVoucher" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-success pull-right" id="save_receive" style="display: none;">Save Receive Voucher</button>
                        </div>                        
                    </div>                    
                </form>
            </div>

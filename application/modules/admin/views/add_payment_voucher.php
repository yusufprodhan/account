                ...
                <form class="form-horizontal" action="<?php echo site_url() ?>admin/paymentVoucher" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" name="save_payment" class="btn btn-success pull-right" id="save_payment" value="Complete Payment Voucher">Save Payment Voucher</button>
                        </div>                        
                    </div>                    
                </form>
            </div>
...
//        $("#cheque_book_number").select2({
//            placeholder: "Select Cheque Book number"
//        });
...
//        $('#voucher_date').datetimepicker('setDate', 'today').on('change', function () {
//            $('.datepicker').hide();
//        });
        ...
        $(document).on("click",'.add_row', function (e) {
            ...
            //$(newRow).insertBefore(".dc_table tbody .tr_prepend");
//            $(".account_head").select2({
//                placeholder: "Select Account Head"
//            });
//            $(".text").select2({
